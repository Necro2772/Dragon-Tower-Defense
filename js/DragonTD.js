...
class DragonTD extends Phaser.Scene {
    ...
    create() {
        ...
        this.towerCards = [
            new TowerCard(TowerType.Fireball, "dragon-fire", "a dragon! crispt!", 60),
            new TowerCard(TowerType.Ice, "dragon-ice", "An ice dragon who freezes their foes with icy breath!", 110),
            new TowerCard(TowerType.Earth, "dragon-earth", "An earth dragon who shoots sharp rock shards!", 100)
        ];
